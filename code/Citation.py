...
def citation_datasets(path="code/data/DawnNet/raw", dataset='DawnNet', alpha=0.1,cv_run=None,adj_type=None):
    ...
    # np.savetxt('D:/keti/DGMP-master/magnet - att - xgnn -plt - local/code/data/{}/raw/{}.feature'.format(dataset, dataset), features1, fmt='%f')
...
if __name__ == "__main__":
    data = citation_datasets(path="code/data/DawnNet/raw", dataset='DawnNet')
